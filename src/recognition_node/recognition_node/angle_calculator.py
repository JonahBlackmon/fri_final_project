    ...
    def process_frame(self, frame):
        ...
        if results.multi_hand_landmarks:
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # Calculate middle finger angles
...
def main():
    ...
    while cap.isOpened():
        ...
        cv2.imshow('Middle Finger Angle Calculator', visualization)
        
        # Print data (optional)
        if data["hand_detected"]:
            print(f"Hand open: {data['is_hand_open']}, "
                  f"Middle finger angle: {data['middle_finger_angle']:.1f}°, "
                  f"Palm direction: {data['palm_direction']:.1f}°")
