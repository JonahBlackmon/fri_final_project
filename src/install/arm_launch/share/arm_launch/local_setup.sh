...
: ${AMENT_CURRENT_PREFIX:="/home/bwilab/fri_ws/src/install/arm_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_launch/environment/path.sh"
