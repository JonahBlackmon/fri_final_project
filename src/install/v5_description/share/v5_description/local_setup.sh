...
: ${AMENT_CURRENT_PREFIX:="/home/bwilab/fri_ws/src/install/v5_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/v5_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/v5_description/environment/path.sh"
